...
def get_solid_angles(abpairs: np.ndarray, incs: np.ndarray) -> np.ndarray:
    ...
    :param abpairs: An array of shape (M \\times N, 6) containing the coordinates of FOV voxel subdivision centroids and detector unit subdivison centroids.
    :type abpairs: numpy.ndarray
    :param incs: An array of shape (N, 3) containing the x,y,z sizes of the detector unit subdivisions in millimeter .
